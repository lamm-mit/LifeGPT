...
data_path = "C:\\Users\\jaime\\ML_Playground_1\\Conway_GPT_v8\\"
...
for epoch in range(NUM_EPOCHS):
    ...
    if (epoch + 1) % SAVE_EPOCH == 0:
        torch.save(model.state_dict(), os.path.join(model_dir, f'Conway_GPT_v7_epoch_{epoch + 1}.pt'))
